...
/*   Updated: 2024/11/12 13:34:55 by nhayoun          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/Fixed.hpp"

Fixed::Fixed() : FixVal(0.0){/*std::cout << "Default constructor called!" << std::endl;*/}
Fixed::Fixed(const int newVal) {FixVal = (newVal << literal);/*std::cout << "Int constructor called!" << std::endl;*/}
Fixed::Fixed(const float newVal){/*std::cout << "Float constructor called!" << std::endl;*/ FixVal = static_cast<int>(roundf((newVal) * (1 << literal)));}
Fixed::~Fixed(){/* std::cout << "Destructor called" << std::endl;*/};
Fixed::Fixed(const Fixed &origin){/*std::cout << "Copy constructor called" << std::endl;*/FixVal = origin.FixVal;}
Fixed& Fixed::operator= (const Fixed& origin) {/*std::cout << "Copy assignment operator called" << std::endl;*/FixVal = origin.FixVal;return *this;}
